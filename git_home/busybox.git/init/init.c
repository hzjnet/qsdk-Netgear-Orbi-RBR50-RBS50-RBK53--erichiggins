...
#define SIG_EMAIL_ALERT 24 /* SIGPWR 30 have been userd, We use SIGXCPU 24 */
...
static void run_shutdown_and_kill_processes(void)
{
	...
	system("echo 0x01 > /proc/reboot_reason");
