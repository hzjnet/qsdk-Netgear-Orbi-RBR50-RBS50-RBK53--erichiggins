...
static int ipv6_pssthrgh_read(struct file *file, char __user *buffer,
			size_t count, loff_t *ppos)
{
        return sprintf(buffer, "%d", ipv6_pssthrgh_enable);
}

static  int ipv6_pssthrgh_write(struct file *file, const char __user *buffer,
       			size_t count, loff_t *ppos)
{
...
static const struct file_operations fops_i6p = {
	.read = ipv6_pssthrgh_read,
	.write = ipv6_pssthrgh_write
};
...
static void pssthrgh_proc_init(void)
{
       ...
       ipv6_pssthrgh = proc_create("ipv6_pssthrgh_enable", 0666, NULL, &fops_i6p);
}
#endif
...
static int switch_phy_read(struct file *file, char __user *buffer,
			size_t count, loff_t *ppos)
{
	return 0;
}
...
static int switch_phy_write(struct file *file, const char __user *buffer,
			size_t count, loff_t *ppos)
{
	struct switch_phy_timer *switch_timer;
	int port;
...
static const struct file_operations fops_sp = {
...
static void dni_switch_phy_init(void)
{
	...
	switch_phy = proc_create(SWITCH_PHY, 0666, NULL, &fops_sp);
}
...
static int blink_wan_led_read(struct file *file, char __user *buffer,
			size_t count, loff_t *ppos)
{
	return 0;
}
...
static int blink_wan_led_write(struct file *file, char const __user *buffer,
			size_t count, loff_t *ppos)
{
	char line[5] = {0};
...
static const struct file_operations fops_bwl = {
...
static void blink_wan_led_init(void)
{
	...
	blink_wan_led = proc_create("blink_wan_led", 0666, NULL, &fops_bwl);
}
...
static int lan_led_ctrl_read(struct file *file, char *buffer,
			size_t count, loff_t *ppos)
{
	return 0;
}

static int lan_led_ctrl_write(struct file *file, const char *buffer,
			size_t count, loff_t *ppos)
{
	char line[5]; 
	int option;
...
static struct file_operations fops_llc = {
...
static void lan_led_ctrl_init(void)
{
	...
	lan_led_ctrl = proc_create(LAN_LED_CTRL, 0666, NULL, &fops_llc);
}
...
static int mirror_wan_read(struct file *file, char __user *buffer,
			size_t count, loff_t *ppos)
{
	return 0;
}

static int mirror_wan_write(struct file *file, const char __user *buffer,
			size_t count, loff_t *ppos)
{
	char line[5]; 
	int state;
...
static const struct file_operations fops_mw = {
...
static void mirror_wan_init(void)
{
	...
	mirror_wan = proc_create(MIRROR_WAN, 0666, NULL, &fops_mw);
}
